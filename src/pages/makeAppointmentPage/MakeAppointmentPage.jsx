    ...
    >
      ...
      <div className='make-appointment-page'>
        ...
        <div className="dashboard__container-header">
          ...
          <h1 className="make-appointment-page__title">Select Barber Location</h1>
              ...
              barber_info.filter((barber) => {
                ...
                return (
                  <div className="make-appointment-page__shop"
                    key={barber.b_id}
                  >
                    <h4>{barber.b_shop_name}</h4>
                    <div className="make-appointment-page__shop__info">
                     
                      <h5>Barber Name: <span>{barber.u_firstname} {barber.u_lastname}</span></h5>
                      <h5>Shop City: <span>{barber.b_city}</span></h5>
                      <h5>See on Map: <a href={`${barber.b_shop_location}`}>Click Here</a></h5>
                      <h5>Shop Status: 
                        <span
                          style={{
