              ...
              isBarber && isBarber === true && (
                <>
                  ...
                  <Form.Group className="inputGrp" controlId="formBasiclocation">
                    <Form.Control className="input" type="text" required placeholder="Enter Shop City" name='b_city'
                      value={userInfo.b_city}
                      onChange={onInputChange}
                      />
                  </Form.Group>
                  <Form.Group className="inputGrp" controlId="formBasicShoplocation">
                    <Form.Control className="input" type="text" required placeholder="Enter Shop Location" name='b_shop_location'
                      value={userInfo.b_shop_location}
                      onChange={onInputChange}
                      />
                  </Form.Group>
                </>
