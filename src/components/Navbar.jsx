  ...
  return (
    <div className="navbar">
        ...
        <div className="user__name">
          { ((window.location.pathname === "/barber-dashboard") || (window.location.pathname === "/customer-dashboard")) && (<h3
              onClick={() => {
                navigate("/settings", { state: { u_info: u_info } })
              }}
          >Hi, <span>{u_firstname}</span></h3>)}
        </div>
